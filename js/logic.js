...
var semesterManager = {
	...
	lastWinterSemester: "WS15/16", /*one of these has to be the current semester*/
...
var modulesRule = {
	...
	check: function(getSemester) {
		...
		// we still build validcombinationsfull which can be displayed by the frontend upon request
